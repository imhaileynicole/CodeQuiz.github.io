// HTML elements that will be used for manipulation
...
var quizQuestions = [{
    ...
    correctAnswer: "d"},
  {
    ...
    correctAnswer: "b"},
   {
    ...
    correctAnswer: "d"},
    {
    question: "What jQuery property can be used to find the number of elements in an object?",
    choiceA: ".Total",
    choiceB: ".Size",
    choiceC: ".Length",
    choiceD: ".Depth",
    ...
    correctAnswer: "c"},
    {
    question: "What is the name of the jQuery element that allows you to select and manipulate HTML objects?",
    choiceA: "Selectors",
    choiceB: "Event",
    choiceC: "Attributes",
    choiceD: "Compressors",
...
// Time variables including Global Variables
